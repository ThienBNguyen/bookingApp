...
const Header = ({ type }) => {
    ...
    // const { user } = useContect(AutoContext)
    return (
                ...
                {type !== "list" && (
                    <>
                        <h1 className="headerTitle">
                            A lifetime of discoun? It's Genius.
                </h1>
                        <p className="headerDesc">
                            Get rewared for your travels - unlock instant saving of 10% or more with a free VaCatBook</p>
                        ...
                        <div className="headerSearch">
                            ...
                            <div className="headerSearchItem">
                                <button className="headerBtn" onClick={handleSearch}>Search</button></div>
                        </div>
                    </>
                )}
            </div>
